...
export default function LoginPage() {
  const [email, setEmail] = useState("abdulhaseeb.solitarydeveloper@gmail.com")
      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-4 sm:p-6 lg:p-8">
        <div className="w-full max-w-md animate-slide-up">
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-primary rounded-2xl mb-6 shadow-lg animate-pulse-glow">
              <Vote className="w-10 h-10 text-primary-foreground" />
            </div>
            <h1 className="text-4xl font-bold text-foreground mb-3 tracking-tight">Election Admin</h1>
            <p className="text-muted-foreground text-lg">Secure access to election management</p>
          </div>
          ...
          <Card className="shadow-2xl border border-border/50 bg-card/80 backdrop-blur-xl transition-all duration-300 hover:shadow-3xl hover:scale-[1.02]">
            <CardHeader className="space-y-2 pb-6">
              <CardTitle className="text-2xl text-center text-card-foreground font-semibold">Sign In</CardTitle>
            ...
            <CardContent className="space-y-6">
              <form onSubmit={handleLogin} className="space-y-6">
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <Input
                      ...
                      required
                      className="h-12 pl-10 bg-input border-border focus:border-accent focus:ring-2 focus:ring-accent/20 transition-all duration-200"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <Input
                      ...
                      required
                      className="h-12 pl-10 pr-12 bg-input border-border focus:border-accent focus:ring-2 focus:ring-accent/20 transition-all duration-200"
                    />
                    <button
                      type="button"
                ...
                <Button
                  type="submit"
                  className="w-full h-12 bg-primary hover:bg-primary/90 text-primary-foreground font-semibold text-base transition-all duration-200 hover:scale-[1.02] hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                  disabled={loading}
                >
                  {loading ? (
              ...
              <div className="mt-8 p-4 bg-muted/50 rounded-lg border border-border/50">
                <div className="text-center text-sm text-muted-foreground">
                  ...
                  <div className="space-y-1">
                    <p className="font-mono text-xs bg-background/50 px-2 py-1 rounded border">
